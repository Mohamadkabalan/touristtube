...
class APICredentials extends flightVO
{
    /**
     * @var string
     */
    ...
    /**
     * Get onProductionServer
     * @return boolean
     */
    public function getOnProductionServer()
    {
        return $this->onProductionServer;
    }
    ...
    /**
     * Set partyIdTo
     * @param String $partyIdTo
     */
    public function setPartyIdTo($partyIdTo)
    {
    ...
    /**
     * Set onProductionServer
     * @param onProductionServer
     */
    public function setOnProductionServer($onProductionServer)
    {
        $this->onProductionServer = $onProductionServer;
    }
