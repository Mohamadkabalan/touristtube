...
/**
 * CorpoAccountTransactions
 *
 * @ORM\Table(name="corpo_account_transactions")
 * @ORM\Entity(repositoryClass="CorporateBundle\Repository\Admin\CorpoAccountTransactionsRepository")
 */
class CorpoAccountTransactions
{
    /**
     * @var integer
     *
