 ...
 * MlThingstodoRegion
 *
 * @ORM\Table(name="ml_thingstodo_region", indexes={@ORM\Index(name="id", columns={"id"}), @ORM\Index(name="id_2", columns={"id"})})
 * @ORM\Entity
 */
class MlThingstodoRegion
{
    /**
     * @var integer
     *
