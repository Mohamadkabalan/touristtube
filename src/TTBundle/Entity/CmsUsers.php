 ...
 */
class CmsUsers implements UserInterface
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="referrer", type="string", length=20, nullable=true)
     */
    private $referrer;
     ...
     * @var string
     *
     * @ORM\Column(name="corpo_account_payment_type", type="string", length=10, nullable=true)
     */
    private $corpoAccountPaymentType;
     ...
     * @var integer
     *
     * @ORM\Column(name="allow_approval_all_user", type="integer", nullable=false)
     */
    private $allowApproval;
    ...
    {
        return ($this->password) ? $this->password : $this->yourpassword;
    }
    ...
    public function getCorpoAccountPaymentType()
    {
        return $this->corpoAccountPaymentType;
    }
    ...
    public function setCorpoAccountPaymentType($corpoAccountPaymentType)
    {
        $this->corpoAccountPaymentType = $corpoAccountPaymentType;
    }
    ...
    {
        if (!$this->cmsUserGroup) return array();
     ...
     * Set fb_user
     *
     * @param string $fb_user
     *
     * @return CmsUsers
     */
    public function setFb_user($fb_user)
    {
     ...
     * @return string
     */
    public function getFb_user()
    {
        return $this->fb_user;
    }

    /**
     * Get allowAccessSubAcc
     *
     * @return integer
     */
    ...
    /**
     * Set allowAccessSubAcc
     *
     * @param string $allowAccessSubAcc
     *
     */
    ...
    /**
     * Set allowAccessSubAccUsers
     *
     * @param string $allowAccessSubAccUsers
     *
     */
     ...
     *
     */
    function setParentUserId($parentUserId)
    {
     ...
     * Set allowApproval
     *
     * @param string $allowApproval
     *
     */
    function setAllowApproval($allowApproval)
    {
