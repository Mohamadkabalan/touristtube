 ...
 * CmsCountries
 *
 * @ORM\Table(name="cms_countries", indexes={@ORM\Index(name="continent_code", columns={"continent_code"}), @ORM\Index(name="name", columns={"name"})})
 * @ORM\Entity
 */
class CmsCountries {
     ...
     * @var integer
     *
     * @ORM\Column(name="dialing_code", type="int")
     */
    private $dialingCode;
