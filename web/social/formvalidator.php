...
//		return true;
//	}
//	function MyValidate(&$formars,&$error_hash)
//	{
//		return true;
//	}
//Commented by Anthony Malak as asked from Charbel Khadra to remove because it's not used  27/04/2015
...
define("E_VAL_REQUIRED_VALUE",_('Please enter the value for %s'));
define("E_VAL_MAXLEN_EXCEEDED",_('Maximum length exceeded for %s'));
define("E_VAL_MINLEN_CHECK_FAILED",_('Please enter input with length more than %d for %s'));
define("E_VAL_ALNUM_CHECK_FAILED",_('Please provide an alpha-numeric input for %s'));
define("E_VAL_ALNUM_S_CHECK_FAILED",_('Please provide an alpha-numeric input for %s'));
define("E_VAL_NUM_CHECK_FAILED",_('Please provide numeric input for %s'));
define("E_VAL_ALPHA_CHECK_FAILED",_('Please provide alphabetic input for %s'));
define("E_VAL_ALPHA_S_CHECK_FAILED",_('Please provide alphabetic input for %s'));
define("E_VAL_EMAIL_CHECK_FAILED",_('Please provide a valid email address'));
define("E_VAL_LESSTHAN_CHECK_FAILED",_('Enter a value less than %f for %s'));
define("E_VAL_GREATERTHAN_CHECK_FAILED",_('Enter a value greater than %f for %s'));
define("E_VAL_REGEXP_CHECK_FAILED",_('Please provide a valid input for %s'));
define("E_VAL_DONTSEL_CHECK_FAILED",_('Wrong option selected for %s'));
define("E_VAL_SELMIN_CHECK_FAILED",_('Please select minimum %d options for %s'));
define("E_VAL_SELONE_CHECK_FAILED",_('Please select an option for %s'));
define("E_VAL_EQELMNT_CHECK_FAILED",_('Value of %s should be same as that of %s'));
define("E_VAL_NEELMNT_CHECK_FAILED",_('Value of %s should not be same as that of %s'));
