...
$(document).ready(function() {
    ...
    $(document).on('click','.account-btn-cancel',function(){
     ...
     $(document).on('click',"#saveabout" ,function(){
        ...
        TTCallAPI({
            what: 'social/share',
            data: {entity_type:SOCIAL_ENTITY_RESTAURANT, entity_id: data_id, share_with : inviteArray, share_type: SOCIAL_SHARE_TYPE_SHARE , msg:invite_msg, channel_id:null,addToFeeds:1},
    ...
    $(document).on('click', "#reviewFormSubmit1", function() {
        ...
        if (jsError != '') {
            ...
            TTCallAPI({
                ...
                data: {entity_type:SOCIAL_ENTITY_RESTAURANT, item_id:data_id, title : '' , description: $("#reviewVal").val() },
                callback: function(ret){
                    if( ret.status === 'error' ){
                        TTAlert({
                            msg: ret.msg,
    ...
    $(document).on('click', ".thumbsForwardEnable,.thumbsBackEnable", function(){
        ...
        $.post(ReturnLink('/ajax/ajax_trestaurant_media.php'),
            { restaurant:theHotel, to:thePage },function(data){
            var ret = null;
            try{
                ret = $.parseJSON(data);
            }catch(Ex){
    ...
    if( $('.hotelListPic').length >0 ){
        $('.hotelListPic').first().click();
    }
    ...
    $('.NewsFeed_ModalRating').each(function(index, element) {
        var $this = $(this);
        ...
        $this.raty({
            ...
            click: function(score, evt) {
                TTCallAPI({
                    ...
                    data: { entity_id : $('#thotel').attr('data-id'), entity_type : $this.attr('data-type') , score : score , globchannelid:null },
                    ret: 'json',
