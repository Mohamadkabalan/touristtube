...
$( document ).ready(function(){
   ...
   $('.hotelsplus').click(function(){
	var $this = $(this);
        if($this.hasClass('stationBag')) return;
        var $parent = $(this).closest('.hotels_cont_inside');
        var id = $parent.attr('data-id');
        var data_country = ""+ ($('#discoverData').attr('data-country')).toUpperCase();
        var data_state = ""+ ($('#discoverData').attr('data-state'));
