...
function AddTuberChat(uid, active){
	...
	if( !checkIfExist(uid) )
	{
		...
		$quickupload = $('<img src="'+AbsolutePath+'/images/quickupload.jpg" id="quickupload">').css({
				'position':'absolute',
				'display':'none',
...
function showChatSettings()
{
	...
	$("#chatSetButton").css('background','url(../images/settings-for-chat-hover.jpg)');
...
function hideChatSettings()
{
	...
	$("#chatSetButton").css('background','url(../images/settings-for-chat.jpg)');
