...
$( document ).ready(function(){
	...
	$("#invitepeoplebutton_user").fancybox({
		...
		var str='<div class="sharepopup_container"><div class="gray13 formContainer100">'+t("invite people to join my event")+'</div><div class="formttl13 formContainer100 margintop26">'+$.i18n._("write something")+'</div><textarea id="invitetext" class="ChaFocus margintop5" onblur="addValue2(this)" onfocus="removeValue2(this)" data-value="'+$.i18n._('write something...')+'" style="font-family:Arial, Helvetica, sans-serif; width:401px; height:42px;" type="text" name="invitetext">'+$.i18n._('write something...')+'</textarea>';
		...
		$.ajax({
			...
			data: {type:'invite_userevent_user',event_id:event_id},
			success: function(data) {
				if(data){
					$('#sharepopup').html(data);
					resetSelectedUsers();
					//addmoreusersautacomplete();
					addmoreusersautocomplete_privacy_journal( $('.addmoretext_user') );
				}
			}
		});
