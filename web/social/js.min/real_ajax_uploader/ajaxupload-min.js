...
(function(c, g) {
    ...
    var k = {
        ...
        //muk   //this.li = c("<li />").appendTo(this.AU.fileList).attr("title", name);
                //muk 15 april 2015       
                // this.li = c("<li />").appendTo(this.AU.fileList).attr("id", name);
                this.li = c("<li />").appendTo(this.AU.fileList);
                a.bootstrap && (this.li = c("<a />").appendTo(this.li));
                this.prevContainer = c('<a class="ax-prev-container" />').appendTo(this.li);
             //   this.details = c('<div class="ax-details upload-icon-photo" />').appendTo(this.li);
                ...
                this.ddbuttons = c('<div class="openclose" />').appendTo(this.li);
               
                //  Change 8 April 2015 for remove default image ------ 
               // this.prevImage = c('<img class="ax-preview" src="" alt="' + f("Preview") + '" />').appendTo(this.prevContainer); 
			    this.prevImage = c('<img class="ax-preview" src="" alt="' + f("") + '" />').appendTo(this.prevContainer); 
                ...
                this.progressBar = c('<div class="ax-progress-bar_1" />').appendTo(this.progressInfo);
                ...
                this.removeButton = c('<a title="Remove file" class="ax-ask-no ax-button" />').appendTo(this.buttons).append('<span class="ax-clear-icon ax-icon"></span>');
...
//                        })
       ...
       //muk    this.li.attr("title", a);
                this.li.attr("title", a);
                this.li.attr("id", name_id[0]);  //muk
                this.li.attr("class", 'success');  //muk
                this.li.attr("data-id", name_id[0]);  //muk
                //this.li.attr("data-isimage", 'false');  //muk
                this.onProgress(100);
                this.uploadButton.removeClass("ax-abort");
    ...
    t.prototype = {
        ...
        renderHtml: function() {
            ...
            var e = "ax-browse-c ax-button",
                b = "ax-upload-all ax-button",
                d = "ax-clear ax-button",
                g = "ax-plus-icon ax-icon",
                h = "ax-upload-icon ax-icon",
                p = "ax-clear-icon ax-icon";
            a.bootstrap && (e += " btn btn-primary", b += " btn btn-success", d += " btn btn-danger", g += " icon-plus-sign", h += " icon-play", p += " icon-remove-sign");
            this.browse_c = c('<a class="' + e + '" title="' + f("Add files") + '" />').append('<span class="' + g + '"></span> <span class="ax-text">' + f("Select files from your computer") + "</span>").appendTo(this.mainWrapper);
            ...
            this.uploadFiles = c('<a class="' + b + '" title="' + f("Upload all files") + '" />').append('<span class="' + h + '"></span> <span class="ax-text">' + f("Start upload") + "</span>").appendTo(this.mainWrapper);
            this.removeFiles = c('<a class="' + d + '" title="' + f("Remove all") + '" />').append('<span class="' + p + '"></span> <span class="ax-text">' + f("Remove all") + "</span>").appendTo(this.mainWrapper);
