...
$(document).ready(function() {
    ...
    $('#submit').click(function() {
        if(!ValidateAddResForm())
            return false;
        else
            $('#add_restaurents').submit();
    });
...
function validateURL(textval) {
...
}function ValidateAddResForm() {
    if ($("#cuisine").val() == '') {
        TTAlert({
            msg: t('Please Select a Cuisine'),
            type: 'alert',
            btn1: 'ok',
            btn2: '',
            btn2Callback: null
    ...
    else if ($("#names_rest").val() == '') {
        TTAlert({
            msg: t('Please Enter a Name for your Restaurant'),
            type: 'alert',
            btn1: 'ok',
            btn2: '',
            btn2Callback: null
        ...
        $("#pac-input").focus();
        return false;
    }else if ($("#price_rest").val()!='' && !IsNumeric($("#price_rest").val())) {
        TTAlert({
        ...
        $("#email").focus();
        return false;
    }else if($("#url_rest").val()!='' && ! validateURL($("#url_rest").val())){
        TTAlert({
        ...
        $("#url_rest").focus();
        return false;
    }else if(! phonenumber($("#phone_rest").val())){
        TTAlert({
