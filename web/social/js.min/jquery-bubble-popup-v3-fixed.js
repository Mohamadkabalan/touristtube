(function (a) {
    ...
    a.fn.CreateBubblePopup = function (e) {
        ...
        function o(v, w) {
            var t = false;
            for (var u in w) {//w.hasOwnProperty(u) &&
                if ( w[u] == v) {
                    t = true;
                    break
                }
                        ...
                        var z = setTimeout(function () {
                            ...
                            switch (H.position) {
                                ...
                                case "top":									
                                    ...
                                    break;
                                case "right":
									var dfltbotval=H.distance;
									if(H.privateVars.is_position_changed && $('.jquerybubblepopup-middle-right .jquerybubblepopup-tail').length==0){
										dfltbotval=-H.distance -5.43*20;
									}
								
                                    y.animate({
                                        opacity: 1,
                                        left: (H.privateVars.is_position_changed ? "+=" : "-=") + dfltbotval + "px"
                                    }, H.openingSpeed, "swing", function () {
                                        H.privateVars.is_animating = false;
                                        H.privateVars.is_animation_complete = true;
                                        d(w, H);
