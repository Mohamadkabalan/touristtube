...
function getMediaDataRelated(one_object) {
    ...
    $.post(ReturnLink('/ajax/ajax_loadmoreprofileimages.php'), {channelid: channelGlobalID(), page: currentpage, frtxt: fr_txt, totxt: to_txt, one_object: one_object}, function(data) {
