...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		startTouch: function(e) {
			if(e.touches.length == 1){
				...
				this.addEventListener('touchend', F.cancelTouch, false);
			}
		},
		...
		_afterLoad: function () {
			...
			switch (type) {
				...
				case 'image':
					/*$(".fancybox-inner").fadeOut(20,function(){
						$(".fancybox-inner").fadeIn(500);
					});*/
	...
	F.transitions = {
		...
		changeIn: function () {
			...
			if (effect === 'none') {
				//$(".fancybox-inner").fadeIn(400).delay(300);
				F._afterZoomInFade();
				
				/*$(".fancybox-inner").animate(endPos, {
