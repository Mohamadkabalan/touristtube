...
;(function($){
	$.contextMenu = {
		...
		createMenu: function(menu,cmenu) {
			...
			var $t = $('<table class="conmn-menu'+cmenu.curid+' conmn-menu" cellspacing=0 cellpadding=0></table>').click(function(){cmenu.hide(); return false;}); // We wrap a table around it so width can be flexible
			var $tr = $('<tr></tr>');
			var $td = $('<td></td>');
		...
		show: function(t,e) {
			...
			if (cmenu.beforeShow()!==false) {
				...
				$c.css( {top:pos.y+"px", left:pos.x+"px", position:"absolute",zIndex:99999} )[cmenu.showTransition](cmenu.showSpeed,((cmenu.showCallback)?function(){cmenu.showCallback.call(cmenu);}:null));
				cmenu.shown=true;
	...
	$.fn.contextMenu = function(menu,options) {
		...
		return this.each(function(){
			$(this).bind('contextmenu',function(e){$(".conmn-menu").hide(this);cmenu.show(this,e);return false;});
		});
	};
})(jQuery);
