...
//    setMap();
    ...
    $(document).on('click', ".rev_infocheckbox .uploadinfocheckboxpic", function () {
        ...
        if (parseInt(user_is_logged) === 0) {
            //$(".TopRegisterLink").click();
            TTAlert({
                msg: t('you need to have a') + ' <a class="black_link" href="' + ReturnLink('/register') + '">' + t('TT account') + '</a> ' + t('in order to select options.'),
                type: 'action',
                btn1: t('cancel'),
                btn2: t('register'),
                btn2Callback: function (data) {
    ...
    $(document).on('click', ".learnMore", function (e) {
        if (parseInt(user_is_logged) === 0) {
            //$(".TopRegisterLink").click();
            TTAlert({
                msg: t('you need to have a') + ' <a class="black_link" href="' + ReturnLink('/register') + '">' + t('TT account') + '</a> ' + t('in order to learn more.'),
                type: 'action',
                btn1: t('cancel'),
                btn2: t('register'),
                btn2Callback: function (data) {
    ...
    $(document).on('click', ".opt", function () {
        if (parseInt(user_is_logged) === 0) {
            //$(".TopRegisterLink").click();
            TTAlert({
                msg: t('you need to have a') + ' <a class="black_link" href="' + ReturnLink('/register') + '">' + t('TT account') + '</a> ' + t('in order to check options.'),
                type: 'action',
                btn1: t('cancel'),
                btn2: t('register'),
                btn2Callback: function (data) {
...
//   / submitReview onclick
    ...
    $(document).on('change', ".rev_select", function () {
        if (parseInt(user_is_logged) === 0) {
            //$(".TopRegisterLink").click();
            TTAlert({
                msg: t('you need to have a') + ' <a class="black_link" href="' + ReturnLink('/register') + '">' + t('TT account') + '</a> ' + t('in order to select travel date.'),
                type: 'action',
                btn1: t('cancel'),
                btn2: t('register'),
                btn2Callback: function (data) {
...
// uploadReviewImg onclick
    $(document).on('click', ".uploadReviewImg", function () {
        if (parseInt(user_is_logged) === 0) {
            $(".TopRegisterLink").click();
            TTAlert({
                msg: t('you need to have a') + ' <a class="black_link" href="' + ReturnLink('/register') + '">' + t('TT account') + '</a> ' + t('in order to add photo.'),
                type: 'action',
                btn1: t('cancel'),
                btn2: t('register'),
                btn2Callback: function (data) {
