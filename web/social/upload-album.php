...
$includes = array('css/upload.css', 'media'=>'css_media_query/media_style.css?v='.MQ_MEDIA_STYLE_CSS_V, 'media1'=>'css_media_query/upload-album.css?v='.MQ_UPLOAD_CSS_V, 'js/upload-behavior.js', 'js/autocomplete-city.js', 'js/jquery.corner.js');
...
if ($location_nameaccent == '') {
    $location_nameaccent = addslashes(_("for better visibility and online search, please fill here"));
}
?>
    ...
    function addanotherappend(newlisting, isImage) {
        ...
        var anotherlistitem = '<div class="formcontainer" style="height: 285px; width:869px;">' +
                ...
                '<div id="' + newlisting + 'save" class="publishbut" style="top:253px;"><div class="LaterButton publishbuttxt"><?php echo addslashes(_('publish later')); ?></div><div class="SaveButton publishbuttxt"><?php echo addslashes(_('publish')); ?></div></div>' +
                '</div>' +
    ...
    function addnewalbumdata(newlisting) {
        ...
        var anotherlistitem = '<div class="formcontainercreatealbum">'+t("CREATE ALBUM")+'</div>' +
                ...
                '<label><div id="privacyclass_user' + USER_PRIVACY_PUBLIC + '" class="privacyclass active" data-value="' + USER_PRIVACY_PUBLIC + '"><div class="privacyclassicon_user' + USER_PRIVACY_PUBLIC + ' privacyclassicons" name="' + newlisting + '_is_public"></div><div class="privacyclasstxt"><?php print addslashes(_("public")); ?></div></div></label>' +
                ...
                '<?php echo $country_options ?>' +
                '</select>' +
                '<div class="uploadinfotitle margintop15"><div><?php print addslashes(_("City")); ?></div><div class="uploadinfomandatory uploadinfomandatorycitynameaccent"><div>*</div><span></span></div></div>' +
                '<input type="text" name="citynameaccent" id="' + newlisting + 'citynameaccent" class="inputuploadformTF" value="<?php echo $citynameaccent; ?>"/>' +
                '<input type="hidden" name="cityname" id="' + newlisting + 'cityname" class="inputuploadformTF" value="<?php echo $cityname; ?>"/>' +
                '<div class="uploadinfotitle uploadpicinfotxt"><div><?php echo addslashes(_('Place taken at'));?></div><div class="uploadinfomandatory uploadinfomandatoryplacetakenat"><div>*</div><span></span></div></div>' +
                '<input type="text" name="placetakenat" id="' + newlisting + 'placetakenat" class="inputuploadformTF" value="<?php echo $location_nameaccent ?>" data-value="' + searchdescriptiontext + '" onfocus="removeValue2(this)" onblur="addValue2(this)"/>' +
                ...
                '<div id="' + newlisting + 'save" class="publishbut" style="top:328px;"><div class="ClearNewAlbumButton publishbuttxt"><?php echo addslashes(_('clear')); ?></div><div class="SaveNewAlbumButton publishbuttxt"><?php echo addslashes(_('save')); ?></div></div>' +
                '</div>' +
                '</div>' +
                '</div>';
    ...
    <div id="InsideNormalup">
        <div id="InsideNormal">
            <div id="uploadheadbar">
                ...
                <a id="uploadinsidemenu2" class="uploadinsidemenu active" href="<?php echo ReturnLink('upload');?>"><?php echo _('album');?></a>
                <a id="uploadinsidemenu3" class="uploadinsidemenu" href="<?php echo ReturnLink('upload');?>"><?php echo _('view my pending list');?></a>
