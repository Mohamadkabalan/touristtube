...
/*! \file
 * 
 * \brief This api returns true/false when user add favourites to a video
 * 
 ...
 * @param vid video id 
 * 
 * @return String added/error if user add favourites to a video
