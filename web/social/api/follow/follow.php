...
/*! \file
 * 
 * \brief This api returns true/false when subscribes one user to another
 * 
 ...
 * 
 * @return String true/false if user subscribes to another
...
//				$subscribeTo = intval($_REQUEST['to']);
				...
				if (intval($userId) != $subscribeTo && userSubscribe($userId,$subscribeTo))
				{
					echo 'true';
				}
				else
