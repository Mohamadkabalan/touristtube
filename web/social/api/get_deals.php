...
//Isert into deal
    ...
    $tour_price = $value->Price_Default;
    $option_query = "INSERT INTO `deal_option` (`deal_id`, `title`, `description`, `price`, `currecy_id`, `nb_persons`) VALUES  ('$inserted_deal_id', 'Tour price', 'Price pre person', $tour_price, 53 , 1)";
