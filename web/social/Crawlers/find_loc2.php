...
function cleanString($text) {
	...
	$n_city= cleanString($n_city);
    
    $n_city1 = str_replace("'","''",trim($n_city));
 ...
 $n_id 	= $_POST['poi_id'];
 $sql1="Select id,name from webgeocities where country_code='BR' and name='$n_city' limit 1"; 
...
$sql="Select id,name as poi_name,latitude as poi_latitude,longitude as poi_longitude,address from tt.discover_poi_new where country='BR' and city_id=0 and status=0 order by latitude DESC limit 1 "; 
    ...
    var xhr = createCORSRequest('POST', url);
           ...
           xhr.onload = function() {
            ...
            count=value.length;
             ...
             document.getElementById("val").value=pinCode;
