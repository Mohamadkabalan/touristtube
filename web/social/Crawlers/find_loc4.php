...
if(isset($_POST['submit']))
{
 ...
 $cc_code_new=$_POST['cc_code'];
 $add_old=$_POST['add_old'];
 $n_details = str_replace("'","''",trim($n_details));
 $n_id 	= $_POST['poi_id'];
 $sql1="Select id,name from webgeocities where country_code='$cc_code_new' and name='$n_city' limit 1"; 
...
$sql="Select country,id,name as poi_name,latitude as poi_latitude,longitude as poi_longitude,address from tt.discover_poi_new where city_id=0 and status=0 and country not in('US','AQ') order by country ASC  limit 1"; 
$result1 = mysqli_query($conn,$sql) or die( mysqli_error());

print "<table border=1>
<tr><td>p_id</td><td>poi_name</td><td>lat</td><td>long</td><td>cc_code</td></tr>";
while($row = mysqli_fetch_array($result1))
{
  ...
  $country= $row['country'];
 print "<tr><td>$id</td><td>$poi_name</td><td>$lat</td><td>$long</td><td>$country</td></tr>";
 

}
print "</table>";
//&key=AIzaSyC_1oEMHTvITs8LCblWTrIDC6CkCZASTpU
?>
...
var url="https://maps.googleapis.com/maps/api/geocode/json?latlng="+
        latitude1+","+longitude1+"&key=AIzaSyAmiruPgOma0q3A5grcnwqfEuXyM0z_h4Q";
...
<br>
<input type="button" name="butt" value="Get Location" onclick="getLocationDetails()"></button>

<br><br>
<input type="text" id="val" name="location">
<input type="text" id="country" name="country">
<input type="text" id="add_old" name="add_old" value="<?php echo $address_old; ?>">
<input type="text" id="cc_code" name="cc_code" value="<?php echo $country; ?>">
...
<input type="submit" name="not_match" value="not match"><br>
