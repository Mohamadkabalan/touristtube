	...
	
	{
	 $detail->find(".langbox__btn-name",0)->plaintext;
		...
		$rating="0";
			...
			echo $Query      =   "INSERT INTO `test`.`zomato_in_restaurant` (`id` ,`res_name` ,`res_description` ,`res_about` ,`res_website` ,`res_address` ,`location`,`city`,`country_name`,`country_code`,`res_contact` ,`res_latitude` ,`res_longitude` ,`res_imagelink` ,`res_link` ,`res_cost` ,`res_feature`,`opening_hr`,`res_fax`,`status`) VALUES ('','$name','$cusine','','$final','$location','$location1','$city','$country','$cc','$tel','$lat','$lng','',$rating,'$price','','$time','','8' )";
