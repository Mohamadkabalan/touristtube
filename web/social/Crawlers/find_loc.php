...
$sql="Select country,id,name as poi_name,latitude as poi_latitude,longitude as poi_longitude,address from tt.discover_poi_new where city_id=0  and country = 'US' order by country DESC  limit 1"; 
