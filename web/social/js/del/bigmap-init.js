	...
	function RetryGetPos(){
		...
		if(navigator.geolocation) {
			...
			navigator.geolocation.getCurrentPosition(function(position) {
				...
				//other markers
				$.ajax({
					url: AbsolutePath + generateLangURL('/ajax/setLocation.php'),
						...
						$.each(ret, function(index,element){
							...
							if(element.image != ''){
								...
								if(element.type=='tuber'){
									imagePath = AbsolutePath + '/media/images/tuber_marker.gif';
									mw = 35;
								}
								else
									imagePath = AbsolutePath + '/media/images/'+element.type+'.gif';
							}
