...
function AddTuberChat(uid, active){
	...
	if( !checkIfExist(uid) )
	{
		...
		$quickupload = $('<div class="quickuploadcontainer" id="quickuploadContainer'+uid+'"><img src="'+AbsolutePath+'/media/images/quickupload.jpg" id="quickupload'+uid+'"></div>').appendTo($('.LeftChatContainer',$newdiv));
		...
		$chatEmoti.click(function () {
			...
			if(!($one_chat_emolist.is(":visible"))){
				...
				$(this).css('background','url('+AbsolutePath+'/media/images/emotiIcon-hover.jpg) center center no-repeat');
				...
				$(this).css('background','url('+AbsolutePath+'/media/images/emotiIcon.jpg) center center no-repeat');	
			}
...
function showChatSettings()
{
	...
	$("#chatSetButton").css('background','url('+AbsolutePath+'/media/images/settings-for-chat-hover.jpg)');
...
function hideChatSettings()
{
	...
	$("#chatSetButton").css('background','url('+AbsolutePath+'/media/images/settings-for-chat.jpg)');
