...
$query = "SELECT h.id, h.name, LCASE(h.name) as name_key, h.description, h.stars, h.popularity, h.published, h.map_image, h.city, h.city_id, h.latitude, h.longitude, h.address, h.street,h.district, h.zip_code, 0 as dupe_pool_id, h.downtown, h.distance_from_downtown, h.airport, h.distance_from_airport, h.train_station, h.distance_from_train_station,
                 ...
                 NOW() as last_updated
          FROM cms_hotel as h 
          LEFT JOIN cms_hotel_source as chs ON (chs.hotel_id = h.id)
