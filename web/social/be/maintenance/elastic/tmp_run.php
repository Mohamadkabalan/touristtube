...
$scripts = array('import_airport.php','import_cities.php','import_deals.php','import_deals_attractions.php','import_hotel_amadeus.php','import_hotel_search_dictionary.php','import_hotels_cities.php','import_channels.php','import_media.php','import_poi.php','import_thingsToDoPages.php','import_location.php','import_discover_hotel.php','import_hotel_hrs.php','import_hotel_hrs_city.php'); // , 'import_rest_geolocation.php');
