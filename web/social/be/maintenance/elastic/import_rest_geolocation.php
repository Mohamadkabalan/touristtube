...
$query = "SELECT r.*,r.name as namePh, CONCAT(r.latitude, ', ', r.longitude) AS geolocation, c.name AS countryName FROM global_restaurants r LEFT JOIN cms_countries c ON (c.code = UPPER(r.country)) WHERE r.published = 1".$conditionalStatement;
