...
<?php echo form_open_multipart('hotel/room_submit');?>
...
<div class="form-group"><label class="col-md-2">Picture 1</label><div class="col-md-9"><?php if($pic1name<>'') echo img(array('src'=>'uploads/rooms/'.$pic1name, 'width'=>150));?> <?php echo form_upload(array('name'=>'pic1','id'=>'pic1'));?> </div></div>
<div class="form-group"><label class="col-md-2">Picture 2</label><div class="col-md-9"><?php if($pic2name<>'') echo  img(array('src'=>'uploads/rooms/'.$pic2name, 'width'=>150));?> <?php echo form_upload(array('name'=>'pic2'));?> </div></div>
<div class="form-group"><label class="col-md-2">Picture 3</label><div class="col-md-9"><?php if($pic3name<>'') echo  img(array('src'=>'uploads/rooms/'.$pic3name, 'width'=>150));?> <?php echo form_upload(array('name'=>'pic3'));?> </div></div>
