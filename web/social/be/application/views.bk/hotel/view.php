...
<div style=" float: left; width: 65%;">
 ...
 <table class="table table-striped">
    ...
    <tr><th>facilities</th><td><?php echo $facilities?>
        <?php foreach($hotel->facility as $f) echo $f->title.", "; ?>
        </td></tr>
...
<td><?= anchor("hotel/room_delete/".$room->id, "Delete");?></td>    
<td><?= anchor("hotel/room_edit/".$room->id, "Edit");?></td>    
</tr> 
<?php  } ?>
</table>
...
<?php foreach($hotel->review as $review){ ?>
<tr>
<td><?= $review->title;?></td>    
<td><?= $review->description;?></td>    
<td><?= anchor("hotel/review_delete/".$review->id, "Delete");?></td>    
<td><?= anchor("hotel/review_edit/".$review->id, "Edit");?></td>    
</tr> 
<?php  } ?>
</table>
</div>
