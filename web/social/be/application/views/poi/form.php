...
$hotel_nearby = $nearby['hotel_nearby'];
$restaurant_nearby = $nearby['restaurant_nearby'];
$poi_nearby = $nearby['poi_nearby'];
}
?>
...
//    ),
    ...
    array(
      'id' => 'hotel_nearby',
      'value' => !empty($hotel_nearby) ? $hotel_nearby : '0',
      'checked' => !empty($hotel_nearby) ? $hotel_nearby : '0',
      'type' => 'checkbox'
    ),
    array(
      'id' => 'restaurant_nearby',
      'value' => !empty($restaurant_nearby) ? $restaurant_nearby : '0',
      'checked' => !empty($restaurant_nearby) ? $restaurant_nearby : '0',
      'type' => 'checkbox'
    ),
    array(
      'id' => 'poi_nearby',
      'value' => !empty($poi_nearby) ? $poi_nearby : '0',
      'checked' => !empty($poi_nearby) ? $poi_nearby : '0',
      'type' => 'checkbox'
    ),
