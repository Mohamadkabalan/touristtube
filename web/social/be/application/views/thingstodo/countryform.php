...
<?php echo form_open_multipart("$controller/country_submit/".$rid);?>
...
<div class="form-group" style="clear:both;"><label class="col-md-2">Related to Region</label><div class="col-md-9"><?php echo form_input(array('name'=>'region', 'value' => $region_id));?></div></div>
