<?php 
    ...
    $this->load->helper('ml_discover_cuisine');
 
?>
<div style="width: 50%; height:150px;">
<h1>New cuisine</h1>
<?php echo validation_errors(); ?>
<?php echo $this->form_builder->open_form(array('action' => "$controller/cuisine_new")); ?>     
<?php
        ...
        <tr>
            ...
            <td>
                <div class="in_edit" id="in_<?= $c['id'];?>">
                    <?php $hi_res = get_ml_discover_cuisine_title($c['id'], 'in');
            ...
            <td>
                <div class="fr_edit" id="fr_<?= $c['id'];?>">
                    <?php $fr_res = get_ml_discover_cuisine_title($c['id'], 'fr');
            ...
            <td>
                <div class="zh_edit" id="zh_<?= $c['id'];?>">
                    <?php $zh_rs = get_ml_discover_cuisine_title($c['id'], 'zh'); 
            ...
            <td>
                <div class="es_edit" id="es_<?= $c['id'];?>">
                    <?php $es_res = get_ml_discover_cuisine_title($c['id'], 'es');
            ...
            <td>
                <div class="pt_edit" id="pt_<?= $c['id'];?>">
                    <?php $pt_res = get_ml_discover_cuisine_title($c['id'], 'pt'); 
            ...
            <td>
                <div class="it_edit" id="it_<?= $c['id'];?>">
                    <?php $it_res = get_ml_discover_cuisine_title($c['id'], 'it'); 
            ...
            <td>
                <div class="de_edit" id="de_<?= $c['id'];?>">
                    <?php $de_res = get_ml_discover_cuisine_title($c['id'], 'de'); 
            ...
            <td>
                <div class="tl_edit" id="tl_<?= $c['id'];?>">
                    <?php $tl_res = get_ml_discover_cuisine_title($c['id'], 'tl'); 
