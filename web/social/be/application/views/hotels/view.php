...
$location = isset($hotel['location'])?$hotel['location']:'';
?>
...
<div style=" float: left; width: 100%; min-height: 1000px;">
 ...
 <table class="table table-striped hotelsTable">
    ...
    <tbody id="facilitiesContainer">
        <tr id="hotelFacilitiesRow"><th>Facilities<?= $user_data['role'] != 'hotel_desc_writers' ? ' ('.anchor("$controller/hotel_facilities/".$id, "Edit").')' : '';?></th>
            <td>
