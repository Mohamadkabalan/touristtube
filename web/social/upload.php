...
//    $CountryIp = $_SERVER["REMOTE_ADDR"];
    ...
    $includes = array(
        ...
        'media1'=>'css_media_query/upload.css?v='.MQ_UPLOAD_CSS_V,
        'css/upload.css',
        //'css/real_ajax_style.css',
        'js/autocomplete-city.js', 
        'js/jquery.corner.js',
        'js/upload-behavior.js',
        //'js/real_ajax_uploader/ajaxupload-min.js',
        //'js/real_ajax.js'
        );
	...
	var anotherlistitem = '<div class="formcontainer" style="height: 405px; width:869px; top:77px;">'+
		'<div class="tableform" style="height:100%; width:100%;">'+
			'<div class="UploadMediaLeftTF">'+
				...
				'<input type="text" name="title" id="'+newlisting+'title" class="inputuploadformTF" maxlength="100" value="<?php print addslashes(_("title..."));?>" data-value="<?php print addslashes(_("title..."));?>" onfocus="removeValue2(this)" onblur="addValue2(this)"/>'+
				...
				'<textarea id="'+newlisting+'description" name="description" class="inputuploaddescriptionTF" data-value="<?php echo addslashes(_('description...'));?>" onfocus="removeValue2(this)" onblur="addValue2(this)"><?php print addslashes(_("description..."));?></textarea>' +	
				...
				'<div class="uploadinfocheckboxcontainer" style="margin-top:24px;">' +
					'<div class="uploadinfocheckbox uploadinfocheckbox_apply4 displanone"><div class="uploadinfocheckboxpic"></div><div class="uploadinfocheckboxtxt"> <?php print addslashes(_("apply the same description to all checked entries"));?></div></div>'+
				'</div>'+
			'</div>'+
			'<div class="UploadMediaRightTF">'+
				...
				'</select>' +
				'<div class="uploadinfotitle margintop15"><div><?php echo addslashes(_("City"));?></div><div class="uploadinfomandatory uploadinfomandatorycitynameaccent"><div>*</div><span></span></div></div>' +
				...
				'<div id="'+newlisting+'save" class="publishbut" style="top:350px;"><div class="LaterButton publishbuttxt"><?php echo addslashes(_('publish later'));?></div><div class="SaveButton publishbuttxt"><?php echo addslashes(_('publish'));?></div></div>'+
			'</div>'+
