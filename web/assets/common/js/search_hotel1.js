...
$(document).ready(function () {
    ...
    $(document).on('click',".filter-hotel-star",function () {
    ...
    $(document).on('click',".filter-hotel-breakfast",function () {
    ...
    $(document).on('click',".filter-hotel-accomodation",function () {
        $('input[name="hotelStar"]').removeAttr('checked');
        $('input[name="hotelPrefrences"]').removeAttr('checked');
        pagenumber = 1;
        if (pageType == 1) {
...
function getsearchrelated() {
    ...
    $.ajax({
        url: generateLangURL('/ajax/search_Hotel'),
        data: {
            type: type,
            city: city,
            hotelStars: hotelStars,
            hotelPrefrences: hotelPrefrences,
...
function getsearchrelatedcategory() {
    ...
    $.ajax({
        url: generateLangURL('/ajax/search_prefix_Hotel'),
        data: {
            search: search,
            hotelStars: hotelStars,
            hotelPrefrences: hotelPrefrences,
...
function getsearchnearby() {
    ...
    $.ajax({
        url: generateLangURL('/ajax/search_near_by_Hotel'),
        data: {
            search: search,
            hotelStars: hotelStars,
            hotelPrefrences: hotelPrefrences,
...
function getsearchHotel() {
    ...
    $.ajax({
        url: generateLangURL('/ajax/search_Hotels'),
        data: {
            search: search,
            hotelStars: hotelStars,
            hotelPrefrences: hotelPrefrences,
