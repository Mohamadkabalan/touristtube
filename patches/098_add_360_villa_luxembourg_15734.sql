...
VALUES
('Street View ',15734,556,1),
('View 1',15734,557,1),
('View 2',15734,558,2),
('Lobby Entrance',15734,1,2),
('View 1',15734,15,1),
('View 2',15734,16,2),
('Breakfast',15734,6,3),
('View 1 ',15734,25,1),
('View 2',15734,26,2),
('Double Room',15734,427,4),
('View 1',15734,428,1),
('View 2',15734,429,2),
('Bathroom',15734,430,3),
('Terrace',15734,431,4),
('Twin Room',15734,246,5),
('View 1',15734,247,1),
('Bathroom',15734,251,1),
('DUPLEX',15734,573,6),
('1st Floor View 1',15734,574,1),
('1st Floor View 2',15734,575,2),
('Top Floor',15734,576,3),
('Top Floor Bathroom ',15734,577,4),
('Connecting Room',15734,578,7),
('View 1',15734,579,1),
('View 2',15734,580,2),
('View 3',15734,581,3),
('View 4',15734,582,4),
('View 5',15734,600,0),
('Family Room',15734,536,8),
('View 1',15734,538,1),
('View 2',15734,539,2),
('Bathroom',15734,540,3),
('Master Bathroom',15734,541,4);



DELETE FROM hotel_to_hotel_divisions_categories WHERE hotel_id = 15734;
...
AND hhd.hotel_id = 15734;


DELETE FROM amadeus_hotel_image WHERE tt_media_type_id =2 AND hotel_id = 15734;
...
(0,'thumb.jpg',15734,558,2,'{"scene": {"view": {"hlookat": "33.955","vlookat" : "-34.207"}}}',null,False,False),
(0,'thumb.jpg',15734,1,2,null,null,False,False),
(0,'thumb.jpg',15734,15,2,'{"scene": {"view": {"hlookat": "-155.546","vlookat" : "0"}}}',null,True,True),
(0,'thumb.jpg',15734,16,2,'{"scene": {"view": {"hlookat": "-120.304","vlookat" : "0"}}}',null,False,False),
...
(0,'thumb.jpg',15734,579,2,'{"scene": {"view": {"hlookat": "-31.064","vlookat" : "2.019"}}}',null,False,False),
(0,'thumb.jpg',15734,580,2,'{"scene": {"view": {"hlookat": "-146.933","vlookat" : "0"}}}',null,False,False),
(0,'thumb.jpg',15734,581,2,'{"scene": {"view": {"hlookat": "-24.035","vlookat" : "0"}}}',null,True,True),
(0,'thumb.jpg',15734,582,2,'{"scene": {"view": {"hlookat": "-105.934","vlookat" : "0"}}}',null,True,True),
(0,'thumb.jpg',15734,600,2,'{"scene": {"view": {"hlookat": "0","vlookat" : "0"}}}',null,False,False),
