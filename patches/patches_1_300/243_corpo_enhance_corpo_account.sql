...
ALTER TABLE `corpo_account` ADD CONSTRAINT `fk_corpo_acc_pay_type`
  FOREIGN KEY (`payment_type_id`)
  REFERENCES `corpo_payment_type` (`id`)
  ON DELETE RESTRICT
  ON UPDATE CASCADE;
  
ALTER TABLE `corpo_account` ADD CONSTRAINT `fk_corpo_acc_parent_acc`
  FOREIGN KEY (`parent_account_id`)
  REFERENCES `corpo_account` (`id`)
  ON DELETE RESTRICT
  ON UPDATE CASCADE;

ALTER TABLE corpo_account CHANGE agency_id agency_id INT(11);

ALTER TABLE `corpo_account` ADD CONSTRAINT `fk_corpo_acc_agency`
...
ALTER TABLE corpo_account DROP FOREIGN KEY fk_corpo_acc_createdby;
...
ALTER TABLE corpo_account DROP FOREIGN KEY fk_corpo_acc_updatedby;
