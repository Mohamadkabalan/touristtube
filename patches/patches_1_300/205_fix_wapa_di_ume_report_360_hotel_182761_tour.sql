DELETE FROM amadeus_hotel_image where hotel_id = 182761 AND tt_media_type_id = 2;
DELETE FROM cms_hotel_image where hotel_id = 182761 AND tt_media_type_id = 2;


INSERT INTO `hotel_to_hotel_divisions`
(`name`,`hotel_id`,`hotel_division_id`,`sort_order`)
VALUES
('Balinese Cooking Lesson',182761,1199,21),
('1',182761,1200,1),
('2',182761,1201,2),
('Balinese Palm Leaf Creation',182761,1205,22),
('1',182761,1206,1);
...
(0,'thumb.jpg',182761,168,2,'{"scene": {"view": {"hlookat": "1.752","vlookat" : "0.000","fov" : "138.266"}}}',null,True,True,4),
...
(0,'thumb.jpg',182761,174,2,'{"scene": {"view": {"hlookat": "2.936","vlookat" : "0.213","fov" : "138.219"}}}',null,True,True,5),
...
(0,'thumb.jpg',182761,993,2,'{"scene": {"view": {"hlookat": "-81.811","vlookat" : "0.520","fov" : "138.818"}}}',null,True,True,6),
...
(0,'thumb.jpg',182761,101,2,'{"scene": {"view": {"hlookat": "-4.587","vlookat" : "0.305","fov" : "138.491"}}}',null,True,True,7),
...
(0,'thumb.jpg',182761,465,2,'{"scene": {"view": {"hlookat": "-1.608","vlookat" : "0.470","fov" : "139.002"}}}',null,True,True,8),
...
(0,'thumb.jpg',182761,80,2,'{"scene": {"view": {"hlookat": "2.128","vlookat" : "0.000","fov" : "138.534"}}}',null,True,True,9),
...
(0,'thumb.jpg',182761,942,2,'{"scene": {"view": {"hlookat": "8.193","vlookat" : "0.547","fov" : "138.931"}}}',null,True,True,10),
...
(0,'thumb.jpg',182761,1006,2,'{"scene": {"view": {"hlookat": "4.722","vlookat" : "0.078","fov" : "137.441"}}}',null,True,True,11),
...
(0,'thumb.jpg',182761,959,2,'{"scene": {"view": {"hlookat": "1.300","vlookat" : "0.000","fov" : "138.70"}}}',null,True,True,12),
...
(0,'thumb.jpg',182761,492,2,'{"scene": {"view": {"hlookat": "2.996","vlookat" : "0.309","fov" : "137.924"}}}',null,True,True,13),
...
(0,'thumb.jpg',182761,591,2,'{"scene": {"view": {"hlookat": "2.890","vlookat" : "1.342","fov" : "138.266"}}}',null,True,True,14),
...
(0,'thumb.jpg',182761,760,2,'{"scene": {"view": {"hlookat": "3.510","vlookat" : "0.835"}}}',null,True,True,15),
...
(0,'thumb.jpg',182761,771,2,'{"scene": {"view": {"hlookat": "5.446","vlookat" : "0.000"}}}',null,True,True,16),
...
(0,'thumb.jpg',182761,781,2,'{"scene": {"view": {"hlookat": "5.232","vlookat" : "0.691"}}}',null,True,True,17),
