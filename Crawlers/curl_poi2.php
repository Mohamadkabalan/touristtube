 ...
 if (mysqli_query($conn, $Query ))
	...
	$state_code='N';	
		...
		if($address_componenets["types"][0]=="administrative_area_level_1") 
		 ...
		 $st_code="select state_code from tt.states where country_code='PF' and state_name='$state'";
...
$Query="update tt.prague_poi set state='$state',n_city_local='$city_local',state_code='$state_code', n_city_admin='$city_admin', status=14 where id=$d_id";
 if (mysqli_query($conn, $Query ))
		    {
